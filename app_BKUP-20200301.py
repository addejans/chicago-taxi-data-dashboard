                    ...
                    children=[
                            ...
                            children=[
                                ...
                                html.Div(
                                    ...
                                    children=[
                                        ...
                                        html.P([html.Br(), 'Display trip line:']),
                                        dcc.Checklist(
                                            id = "trip-selector",
                                            inputStyle={"margin-right": "10px"},
                                            style = {
                                            ...
                                            options=[
                                                {'label': 'Show trip line* (temporarily disabled)', 'value': 'TRUE'}
                                            ],
                                            value=['MTL', 'SF'],
                        ...
                        dcc.RangeSlider(
                            ...
                            marks={
                                ...
                                5: {'label': '$5', 'style': {'color': '#0000FF'} },
                                10: {'label': '$10', 'style': {'color': '#0000FF'}},
                                15: {'label': '$15', 'style': {'color': '#0000FF'}},
                                20: {'label': '$20', 'style': {'color': '#0000FF'}},
                                25: {'label': '$25', 'style': {'color': '#0000FF'}},
                                30: {'label': '$30', 'style': {'color': '#0000FF'}},
                                35: {'label': '$35', 'style': {'color': '#0000FF'}},
                                40: {'label': '$40', 'style': {'color': '#0000FF'}},
                                45: {'label': '$45', 'style': {'color': '#0000FF'}},
                                50: {'label': '$50', 'style': {'color': '#0000FF'}},
                    ...
                    children=[
                        ...
                        dcc.Markdown(
                            children=[
                                "---",
                                "#### Taxi Fare Heat-Map",
                                "(not linked to histogram filtering)"
                            ]
                        ),
...
def update_graph(datePicked, selectedData, selectedLocation, pudoSelection):
    zoom = 9.0
...
@app.callback(
    ...
    [
        ...
        Input("bar-selector", "value"),
        Input("location-dropdown", "value"),
        Input('fare-slider', 'value'), #//TODO: Change color of slider on selected node
        Input('PUDO-selector', 'value'),
    ],
)
def update_graph(datePicked, selectedData, selectedLocation, selectedRange, pudoSelection):
    ...
    dayPicked = date_picked.day - 15
    # listCoords = getLatLonColor(selectedData, monthPicked, dayPicked)
    listCoords = getLatLonFareColor(selectedData, monthPicked, dayPicked, selectedRange)
